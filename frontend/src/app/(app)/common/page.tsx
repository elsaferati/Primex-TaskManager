...
function OneHMarkerLegend() {
  return (
    <div className="one-h-marker-legend">
      ...
      <i aria-hidden="true">/</i>
      <span><b className="compact-marker">M2/M3</b> - DET QE DUHET TE DORZOHEN EDHE M2 EDHE M3</span>
      <i aria-hidden="true">/</i>
