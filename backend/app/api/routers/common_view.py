                    ...
                    items["blocked"].append(
                        {
                            ...
                            "one_h_marker_by_ga": active_one_h_marker_by_ga(t, one_h_slot_date),
                            "one_h_marker_comment": t.one_h_marker_comment if active_one_h_marker(t, one_h_slot_date) else None,
