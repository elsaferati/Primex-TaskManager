...
class EndWeekBzReportDraft(Base):
    __tablename__ = "end_week_bz_report_drafts"
    __table_args__ = (UniqueConstraint("report_date", name="uq_end_week_bz_report_draft_date"),)
