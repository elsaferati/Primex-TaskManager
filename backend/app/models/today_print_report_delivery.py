...
class TodayPrintReportDelivery(Base):
    __tablename__ = "today_print_report_deliveries"
    __table_args__ = (UniqueConstraint("delivery_date", name="uq_today_print_report_delivery_date"),)
