...
def upgrade() -> None:
    ...
    template = {
        ...
        "rows": [
            ...
            {"nr": 7, "topic": "A eshte derguar linku i takimit ne Teams ne grupin PX GRUPI TAKIMET EXT - LINQET?"},
            {"nr": 8, "topic": "Koha e takimit: Takimi : 1h 30min , perveq kur kemi workshops , konf me ga/ka me cfare kohezgjatje me dergu"},
            {
                "nr": 9,
            ...
            {"nr": 10, "topic": "A eshte bere accept takimi nga pjesmarresit?"},
            {"nr": 11, "topic": "Pas perfundimit te takimit, ndahen te gjitha detyrat?"},
            {
                "nr": 12,
